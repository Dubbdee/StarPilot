...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LaneCenteringStrength", {PERSISTENT, FLOAT, "0.30", "0.30", 3}},
    {"LaneCenteringResponseTime", {PERSISTENT, FLOAT, "0.40", "0.40", 3}},
    {"LaneCenteringDeadband", {PERSISTENT, FLOAT, "0.08", "0.08", 3}},
